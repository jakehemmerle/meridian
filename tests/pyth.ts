...
test("rejects a settlement snapshot when the confidence band is too wide", () => {
  assert.throws(
    () =>
      validateSettlementSnapshot(
        {
          id: MERIDIAN_TICKER_FEEDS.GOOGL,
          price: {
            price: "17500000000",
            conf: "87500000",
            expo: -8,
